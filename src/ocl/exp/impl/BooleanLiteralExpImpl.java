 ...
 * </p>
 * <ul>
 *   <li>{@link ocl.exp.impl.BooleanLiteralExpImpl#getBooleanValue <em>Boolean Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanLiteralExpImpl extends OclExpressionImpl implements BooleanLiteralExp {
	...
	protected EClass eStaticClass() {
		return ExpPackage.Literals.BOOLEAN_LITERAL_EXP;
	}
	...
	public void setBooleanValue(Boolean newBooleanValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpPackage.BOOLEAN_LITERAL_EXP__BOOLEAN_VALUE, oldBooleanValue, booleanValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpPackage.BOOLEAN_LITERAL_EXP__BOOLEAN_VALUE:
