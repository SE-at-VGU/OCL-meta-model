...
public class ExpFactoryImpl extends EFactoryImpl implements ExpFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ExpPackage.VARIABLE_EXP: return createVariableExp();
			case ExpPackage.TYPE_EXP: return createTypeExp();
			case ExpPackage.ASSOCIATION_CLASS_CALL_EXP: return createAssociationClassCallExp();
			case ExpPackage.VARIABLE: return createVariable();
			case ExpPackage.PROPERTY_CALL_EXP: return createPropertyCallExp();
			case ExpPackage.ITERATOR_EXP: return createIteratorExp();
			case ExpPackage.INTEGER_LITERAL_EXP: return createIntegerLiteralExp();
			case ExpPackage.OPERATION_CALL_EXP: return createOperationCallExp();
			case ExpPackage.STRING_LITERAL_EXP: return createStringLiteralExp();
			case ExpPackage.BOOLEAN_LITERAL_EXP: return createBooleanLiteralExp();
			default:
