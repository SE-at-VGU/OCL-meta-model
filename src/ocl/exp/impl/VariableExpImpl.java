 ...
 * </p>
 * <ul>
 *   <li>{@link ocl.exp.impl.VariableExpImpl#getReferredVariable <em>Referred Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableExpImpl extends OclExpressionImpl implements VariableExp {
	...
	protected EClass eStaticClass() {
		return ExpPackage.Literals.VARIABLE_EXP;
	}
		...
		if (referredVariable != null && referredVariable.eIsProxy()) {
			...
			if (referredVariable != oldReferredVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExpPackage.VARIABLE_EXP__REFERRED_VARIABLE, oldReferredVariable, referredVariable));
			}
		}
	...
	public void setReferredVariable(Variable newReferredVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpPackage.VARIABLE_EXP__REFERRED_VARIABLE, oldReferredVariable, referredVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpPackage.VARIABLE_EXP__REFERRED_VARIABLE:
