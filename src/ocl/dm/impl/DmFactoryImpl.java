...
public class DmFactoryImpl extends EFactoryImpl implements DmFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DmPackage.ENTITY: return createEntity();
			case DmPackage.ASSOCIATION_END: return createAssociationEnd();
			case DmPackage.DATA_MODEL: return createDataModel();
			case DmPackage.ATTRIBUTE: return createAttribute();
			default:
