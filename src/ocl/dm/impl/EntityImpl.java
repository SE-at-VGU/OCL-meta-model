...
import ocl.type.impl.ClassifierImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link ocl.dm.impl.EntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link ocl.dm.impl.EntityImpl#getEnds <em>Ends</em>}</li>
 *   <li>{@link ocl.dm.impl.EntityImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityImpl extends ClassifierImpl implements Entity {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmPackage.ENTITY__NAME, oldName, name));
	}
	...
	public EList<AssociationEnd> getEnds() {
		if (ends == null) {
			ends = new EObjectContainmentEList<AssociationEnd>(AssociationEnd.class, this, DmPackage.ENTITY__ENDS);
		}
		return ends;
	}
