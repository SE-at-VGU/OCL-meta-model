 ...
 * </p>
 * <ul>
 *   <li>{@link ocl.dm.impl.DataModelImpl#getClasses <em>Classes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataModelImpl extends MinimalEObjectImpl.Container implements DataModel {
	...
	public EList<Entity> getClasses() {
		if (classes == null) {
			classes = new EObjectContainmentEList<Entity>(Entity.class, this, DmPackage.DATA_MODEL__CLASSES);
		}
		return classes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmPackage.DATA_MODEL__CLASSES:
