 ...
 * </p>
 * <ul>
 *   <li>{@link ocl.type.impl.CollectionTypeImpl#getElementType <em>Element Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionTypeImpl extends DataTypeImpl implements CollectionType {
	...
	protected EClass eStaticClass() {
		return TypePackage.Literals.COLLECTION_TYPE;
	}
		...
		if (elementType != null && elementType.eIsProxy()) {
			...
			if (elementType != oldElementType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypePackage.COLLECTION_TYPE__ELEMENT_TYPE, oldElementType, elementType));
			}
		}
		return elementType;
	}
	...
	public void setElementType(Classifier newElementType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.COLLECTION_TYPE__ELEMENT_TYPE, oldElementType, elementType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypePackage.COLLECTION_TYPE__ELEMENT_TYPE:
