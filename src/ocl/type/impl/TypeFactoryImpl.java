...
public class TypeFactoryImpl extends EFactoryImpl implements TypeFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TypePackage.INVALID_TYPE: return createInvalidType();
			case TypePackage.VOID_TYPE: return createVoidType();
			case TypePackage.ANY_TYPE: return createAnyType();
			case TypePackage.MESSAGE_TYPE: return createMessageType();
			case TypePackage.COLLECTION_TYPE: return createCollectionType();
			case TypePackage.PRIMITIVE_TYPE: return createPrimitiveType();
			case TypePackage.TUPLE_TYPE: return createTupleType();
			case TypePackage.ORDERED_SET_TYPE: return createOrderedSetType();
			case TypePackage.SEQUENCE_TYPE: return createSequenceType();
			case TypePackage.BAG_TYPE: return createBagType();
			case TypePackage.SET_TYPE: return createSetType();
			case TypePackage.SIGNAL: return createSignal();
			default:
