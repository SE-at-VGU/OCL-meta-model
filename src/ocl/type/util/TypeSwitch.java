...
public class TypeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TypePackage.COLLECTION_TYPE: {
			...
			case TypePackage.ORDERED_SET_TYPE: {
			...
			case TypePackage.SEQUENCE_TYPE: {
